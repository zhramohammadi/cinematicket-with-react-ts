...
import {artAndExperience} from "../../../../data/categories/ArtAndExperience/ArtAndExperience.tsx";
import {GoChevronLeft, GoHeartFill } from "react-icons/go";
import { LuUser } from "react-icons/lu";
function ArtAndExperience(){
    return(
        <>
            <div className="d-flex justify-content-between m-2 mt-lg-5">
                ...
                <p className="mx-lg-3 section" id={'artAndExperience'}>هنر و تجربه</p>
            </div>

            <Row xs={3} md={3} lg={4} xl={5} className="mx-1 mb-5">
                {artAndExperience.map((moviesList) => (
...
export default ArtAndExperience;