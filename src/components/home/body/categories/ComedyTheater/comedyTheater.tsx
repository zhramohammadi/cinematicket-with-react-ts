...
import {comedyTheater} from "../../../../data/categories/comedyTheater/comedyTheater.tsx";
    ...
    return(
        <>
            <div className="d-flex justify-content-between m-2 mt-lg-5">
                ...
                <p className="mx-lg-3 section" id={'comedyTheater'}>تئاتر کمدی</p>
            </div>

            <Row xs={3} md={3} lg={4} xl={5} className="mx-1">
                {comedyTheater.map((moviesList) => (
