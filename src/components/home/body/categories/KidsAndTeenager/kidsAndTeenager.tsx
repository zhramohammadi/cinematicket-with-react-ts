...
import {kidsAndTeenager} from "../../../../data/categories/KidsAndTeenager/KidsAndTeenager.tsx";
import {GoChevronLeft, GoHeartFill } from "react-icons/go";
import { LuUser } from "react-icons/lu";
function KidsAndTeenager(){
    return(
        <>
            <div className="d-flex justify-content-between m-2 mt-lg-5">
                ...
                <p className="mx-lg-3 section" id={'kidsAndTeenager'}>کودک و نوجوان</p>
            </div>

            <Row xs={3} md={3} lg={4} xl={5} className="mx-1">
                {kidsAndTeenager.map((moviesList) => (
...
export default KidsAndTeenager;