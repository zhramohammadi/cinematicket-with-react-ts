                          ...
                          <CarouselCaption >
                              <div className="text-end mb-5 col-lg-10 col-md-8 col-sm-5 caption ">
                                  ...
                                  <div>
                                      ...
                                      <div className=" mb-1">
                                          <span className="DescriptionTime  d-lg-inline-block d-md-inline-block d-sm-inline-block d-none">رای {item.votes}</span>
                                          <span className="Description d-inline-block">
                                            {item.ating} <GoHeartFill className="m-1 text-danger" />
                                          </span>
                                          <span className="DescriptionTime d-lg-inline-block d-md-inline-block d-sm-inline-block d-none">{item.duration}</span>
